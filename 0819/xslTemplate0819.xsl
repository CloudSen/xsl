...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="sign">
        <div class="signContent">
            ...
            <div class="signDiv">
                ...
                <xsl:element name="input">
                    <xsl:attribute name="id"> <xsl:value-of select="./mech/mechname/input/@id"/></xsl:attribute>
                ...
                <xsl:element name="input">
                    <xsl:attribute name="id"> <xsl:value-of select="./mech/mechdate/input/@id"/></xsl:attribute>
                ...
                <xsl:if test="string(./mech/@checklevel)!=''">
                    <xsl:element name="span">
                        <xsl:text>RCI/RII：</xsl:text>
                    </xsl:element>
                    <xsl:element name="input">
                        <xsl:attribute name="id">checkType</xsl:attribute>
                        <xsl:attribute name="name">checkType</xsl:attribute>
                        <xsl:attribute name="type">text</xsl:attribute>
                        <xsl:attribute name="value"> <xsl:value-of select="./mech/@checklevel"/></xsl:attribute>
                        <xsl:attribute name="class">input</xsl:attribute>
                        <xsl:attribute name="disabled">true</xsl:attribute>
                    </xsl:element>
                    <xsl:element name="span">
                    ...
                    <xsl:element name="input">
                        <xsl:attribute name="id"> <xsl:value-of select="./insp/inspname/input/@id"/></xsl:attribute>
                    ...
                    <xsl:element name="input">
                        <xsl:attribute name="id"> <xsl:value-of select="./insp/inspdate/input/@id"/></xsl:attribute>
    ...
    <xsl:template match="input">
        <xsl:choose>
            <xsl:when test="local-name(parent::node()) = 'entry'">
